    ...
    return (
        <div>
            <div className="mx-auto min-h-screen max-w-screen-2xl bg-white px-4 py-16 text-center sm:px-16 ">
                ...
                <a href="#" className="inline-flex shadow-md items-center mt-6 px-6 py-3 bg-[#e31c24] rounded-md text-white hover:bg-blue-950 font-semibold duration-500 transition">
            View All Courses
        </a>
            </div>
        </div>
