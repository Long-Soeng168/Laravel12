...
const OurIntegratedSolutions = () => {
    return (
        <div className="mx-auto max-w-7xl space-y-12 p-8 my-20">
            {/* Headline */}
            <h1 className="text-center text-4xl font-bold">Our Integrated Solutions</h1>

            <p className="mx-auto max-w-3xl text-center text-lg ">
                Tailored for Your Success: We recognize that a one-size-fits-all approach falls short in the dynamic world of education. That’s why we
