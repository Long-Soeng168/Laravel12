                    ...
                    <CarouselItem key={index} className="pl-10 sm:basis-1/2 lg:basis-1/4">
                        <div>
                            <div className="flex h-full w-full items-end">
                                <p
                                    className={cn(
                                        'text-true-primary text-true-primary-two text-true-primary-three text-true-primary-four mr-2 translate-y-[7px] text-2xl font-bold',
                                ...
                                <div className="flex flex-1 flex-col">
                                    ...
                                    <div
                                        className={cn(
                                            'bg-true-primary bg-true-primary-two bg-true-primary-three bg-true-primary-four h-5 w-full',
                            ...
                            <div className="flex h-full w-full items-end">
                                <p className={`text-${Colors[index % Colors.length]} invisible mr-2 translate-y-1 text-2xl font-bold`}>2007</p>
                                <div className="flex flex-1 flex-col">
