...
const MyWiscare = () => (
    <div className="flex items-center justify-center pt-12 pb-16 md:pt-16">
        <div className="mx-auto w-full max-w-screen-2xl px-6 xl:px-0">
            <h2 className="mt-3 text-center text-3xl font-bold tracking-tight text-blue-900 md:text-4xl">How to Wiscare your child</h2>
                ...
                {items.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <h3 className="mt-4 text-2xl text-red-700">{item.title}</h3>
                            <p className="mt-5 text-base text-blue-900 ">{item.description}</p>
                            <p className=" text-base text-blue-900 ">{item.sort}</p>
                        </div>
                    );
                })}
            </div>
