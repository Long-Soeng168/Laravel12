        ...
        <div>
            <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10 px-6 py-16">
                <div className="max-w-2xl text-center">
                    <h1 className="mt-6 text-4xl !leading-[1.2] font-bold tracking-tight sm:text-5xl md:text-6xl">Our Vision</h1>
                </div>
            ...
            <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10 px-6 py-16">
                <div className="max-w-2xl text-center">
                    <h1 className="mt-6 text-4xl !leading-[1.2] font-bold tracking-tight sm:text-5xl md:text-6xl">LIBRARY</h1>
                </div>
            ...
            <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10 px-6 py-16">
                <div className="max-w-2xl text-center">
                    <h1 className="mt-6 text-4xl !leading-[1.2] font-bold tracking-tight sm:text-5xl md:text-6xl">SIEBD LABORATORY</h1>
                </div>
            ...
            <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10 px-6 py-16">
                <div className="max-w-2xl text-center">
                    <h1 className="mt-6 text-4xl !leading-[1.2] font-bold tracking-tight sm:text-5xl md:text-6xl">OUTDOOR PLAY AREAS</h1>
                </div>
            ...
            <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10 px-6 py-16">
                <div className="max-w-2xl text-center">
                    <h1 className="mt-6 text-4xl !leading-[1.2] font-bold tracking-tight sm:text-5xl md:text-6xl">CANTEEN</h1>
                </div>
            ...
            <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10 px-6 py-16">
                <div className="max-w-2xl text-center">
                    <h1 className="mt-6 text-4xl !leading-[1.2] font-bold tracking-tight sm:text-5xl md:text-6xl">MUSIC AND DANCE</h1>
                </div>
