...
class BannerPositionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($image_file) {
            try {
                $created_image_name = ImageHelper::uploadAndResizeImage($image_file, 'assets/images/banner_positions', 600);
        ...
        if ($banner_file) {
            try {
                $created_image_name = ImageHelper::uploadAndResizeImage($banner_file, 'assets/images/banner_positions', 900);
